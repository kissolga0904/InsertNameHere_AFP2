...
- A helymeghatározás megvalósítása a telefon szenzorainak (accelerometer, gyroscope, stb.) használatával fog történni
- További céljaink között szerepel az, hogy egy Python alkalmazásban az adatokat grafikonok segítségével meg tudjuk jeleníteni
- Az alkalmazásunkat könnyen futtathatónak és kezelhetőnek tervezzük, hogy a hozzá nem értők számára is felfogható legyen. Épp ezért szükségünk lesz egy Node.JS WebSocket-re, amin keresztül könnyen tudjuk exportálni az adatainkat az Android alkalmazásból és importálni ezeket a Python alkalmazásba.
